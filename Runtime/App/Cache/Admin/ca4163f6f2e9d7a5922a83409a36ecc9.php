<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent"   layouth="1">
	<div class="pageFormContent">
	 ...
	 <form action="/ehview/index.php/Admin/Config/save/navTabId/<?php echo CONTROLLER_NAME;?>" id="j_custom_form" class="pageForm form-validate" method="post" callback="navTabAjaxDone" noEnter>
	...
	<?php if(is_array(C("CONFIG_GROUP_LIST"))): $i = 0; $__LIST__ = C("CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><div id="tab<?php echo ($key); ?>" class="tab-pane  fade <?php if(($key) == "1"): ?>in active<?php endif; ?>">
		...
		<div class="formBar">
            <ul>
                ...
                <li><button type="button" url="/ehview/index.php/Admin/Config" class="btn btn-close btn-sm ">取消</button></li>
            </ul>
		</div>
