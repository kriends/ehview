...
<form id="pagerForm" action="/ehview/index.php/Admin/Config" method="post">
    ...
    <form onsubmit="return navTabSearch(this);"  class="form-inline" action="/ehview/index.php/Admin/Config" method="post">
       ...
       <div class="form-group" size="12"><label>分组：</label>
                ...
                <a href="/ehview/index.php/Admin/Config/add" rel="configadd"  target="navtab" title="新增配置项" class="btn btn-primary btn-sm"><i class="icon-plus"></i> 新增</a>
                ...
                <div class="pull-right btn-group">
                                  ...
                                  <div class="log-arrow-up"></div>
                                      <li><a href="/ehview/index.php/Admin/Config/selectedDelete"  title="确定要删除选中信息吗？" target="checkedAjaxTodo" idname="ids">删除选中</a></li>
                                  </ul>
                </div>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?><tr>
            <td></td>
                ...
                <div class="btn-group  btn-group-xs">
                    <a href="/ehview/index.php/Admin/Config/edit/id/<?php echo ($config['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>" rel="configedit<?php echo ($config['id']); ?>"  class="btn btn-primary"  target="navtab" title="编辑配置项" ><i class="icon-edit"></i> 编辑</a>
                    
                    <a href="/ehview/index.php/Admin/Config/foreverdelete/id/<?php echo ($config['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-danger" target="ajaxTodo" title="确定要删除该行信息吗？"><i class="icon-trash"></i> 删除</a>
                </div>
                </td>
