...
<form id="pagerForm" action="/ehview/index.php/Admin/Node" method="post">
    ...
    <form onsubmit="return navTabSearch(this);" class="form-inline" action="/ehview/index.php/Admin/Node" method="post">
       <input type="hidden" name="pid" value="<?php echo ($currentid); ?>"/>
        <div class="form-group" size="20">
         <label>节点标识：</label><input type="text" value="<?php echo ($_REQUEST["name"]); ?>" name="name" class="form-control" size="10" />
          ...
          <a href="/ehview/index.php/Admin/Node/add" target="dialog" mask="true"  width="500" height="400" class="btn btn-green btn-sm">新增</a>
                <?php if($rebackid > 0): ?><a href="/ehview/index.php/Admin/Node/index/pid/<?php echo ($rebackid); ?>/"  target="navTab" rel="<?php echo CONTROLLER_NAME;?>" title="节点管理" class="btn btn-green btn-sm">返回</a><?php endif; ?>
          </div>
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu right" role="menu">
                            ...
                            <li><a href="/ehview/index.php/Admin/Node/selectedDelete"  title="确定要删除选中信息吗？" target="checkedAjaxTodo" idname="ids">删除选中</a></li>
                        </ul>
                    </div>
    ...
    <table class="j-table" width="100%" layoutH="95">
        ...
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td></td>
					<td><a href="/ehview/index.php/Admin/Node/index/pid/<?php echo ($vo['id']); ?>/" target="navTab" rel="/ehview/index.php/Admin" title="节点管理"><?php echo ($vo['name']); ?></a></td>
                ...
                <td>
                    <a href="/ehview/index.php/Admin/Node/edit/id/<?php echo ($vo['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"   class="btn btn-green btn-sm" target="dialog"  mask="true"  width="500" height="400" >编辑</a>
                    <?php echo (showstatus($vo['status'],$vo['id'],CONTROLLER_NAME)); ?>
                    <a href="/ehview/index.php/Admin/Node/foreverdelete/id/<?php echo ($vo['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-red btn-sm" target="ajaxTodo" title="确定要删除该行信息吗？">删</a>
                </td>
