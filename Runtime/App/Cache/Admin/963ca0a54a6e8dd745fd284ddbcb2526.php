...
<div class="pageContent">
    <form action="/ehview/index.php/Admin/Role/setGroupAll/navTabId/<?php echo CONTROLLER_NAME;?>" id="j_custom_form" class="pageForm form-validate" method="post" callback="dialogAjaxDone" noEnter>
